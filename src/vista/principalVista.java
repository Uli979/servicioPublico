...
public class principalVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Gestionar Registro");
        ...
        jLabel2.setText("EMPRESA PRESTADORA DE SERVICIOS PUBLICOS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       GestionUsuario gestionUsuario = null;
        try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            GestionRegistro gestionRegistro=new GestionRegistro();
            gestionRegistro.setVisible(true);
            this.dispose();
        } catch (SQLException ex) {
            Logger.getLogger(principalVista.class.getName()).log(Level.SEVERE, null, ex);
        }
